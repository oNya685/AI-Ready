...
1. Read: `nanobot/skills/multimodal-augmentation/scripts/shard_jsonl.py`
...
1. Read: `nanobot/skills/multimodal-augmentation/scripts/merge_jsonl.py`
...
`nanobot/skills/multimodal-augmentation/scripts/template_multimodal.py`
